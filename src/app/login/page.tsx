      ...
      <div className="w-full max-w-md rounded-xl border border-white/10 bg-[#111111] p-8 shadow-2xl">
        ...
        <div className="mb-6 space-y-3">
          <button
            ...
            disabled={isPending}
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm font-medium text-white transition hover:bg-white/10 disabled:cursor-not-allowed disabled:opacity-50"
          >
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-[#111111] px-3 text-gray-500">eller</span>
          </div>
        </div>
